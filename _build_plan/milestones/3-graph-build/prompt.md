...
- Read previous milestone folders (`@_build_plan/milestones/1-*/milestone-log.md`, `@_build_plan/milestones/2-*/milestone-log.md`) to understand what has already been built.
- The graph traversal and community-detection method is adapted from the Stell-R paper at `docs/research/stell-r-artist-influence-hdsr.md` (Appendix A holds the four algorithms' pseudocode).
